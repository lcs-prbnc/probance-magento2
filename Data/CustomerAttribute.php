    ...
    public function getAttributes()
    {
        return [
            ...
            [
                ...
                'probance_attribute' => 'postal_code',
                'field_type' => 'text',
                'position' => 10,
            ],
            [
            ...
            [
                ...
                'probance_attribute' => 'lang',
                'field_type' => 'text',
                'position' => 13,
            ],
            [
                'magento_attribute' => 'empty_field',
                'probance_attribute' => 'origin',
                'field_type' => 'text',
                'position' => 14,
            ],
            [
                'magento_attribute' => 'billing_address_phone',
                'probance_attribute' => 'phone_number',
                'field_type' => 'text',
                'position' => 15,
            ],
            [
            ...
            [
                'magento_attribute' => 'empty_field',
                'probance_attribute' => 'option_tag1',
                'field_type' => 'text',
                'position' => 24,
            ],
            [
                'magento_attribute' => 'empty_field',
                'probance_attribute' => 'to_exclude',
                'field_type' => 'text',
                'position' => 25,
            ],
            [
                'magento_attribute' => 'empty_field',
                'probance_attribute' => 'to_delete',
                'field_type' => 'text',
                'position' => 26,
            ],
        ];
